...
- **Cơ sở dữ liệu (Database):** [Firebase / Firestore](https://firebase.google.com/)
...
Các thông tin quan trọng nhất cần điền: `FIREBASE_CREDENTIALS` (dạng JSON string), `REDIS_HOST`, `REDIS_PASSWORD`, `JWT_SECRET`.
